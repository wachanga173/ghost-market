...
export default function Hero() {
  ...
  return (
    <section className="relative isolate min-h-screen w-full overflow-hidden bg-gradient-to-b from-gray-950 via-purple-950/10 to-black">
      ...
      {/* Centered cinematic video rail to preserve original hero composition */}
      <div className="pointer-events-none absolute inset-x-0 bottom-24 z-10 hidden justify-center lg:flex">
        <div className="relative w-[min(86vw,960px)] aspect-video overflow-hidden rounded-2xl border border-white/15 bg-black/30 shadow-[0_24px_90px_-30px_rgba(34,211,238,0.55)] backdrop-blur-sm">
          <video
            ...
            muted
            playsInline
            className="absolute inset-0 h-full w-full object-cover opacity-28 blur-sm scale-110"
          />
          <div className="absolute inset-0 flex items-center justify-center">
            <video
              ...
              muted
              playsInline
              className="h-full max-h-full w-auto object-contain opacity-78"
            />
          </div>
